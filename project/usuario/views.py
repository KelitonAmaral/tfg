...
class AlunoListView(LoginRequiredMixin, ListView):
    model = Usuario
    template_name = 'usuario/aluno_list.html'
...
class UsuarioCreateView(LoginRequiredMixin, CoordenadorRequiredMixin, CreateView):
    model = Usuario
    fields = ['tipo', 'curso', 'nome', 'email', 'password','cpf' ,'matricula', 'fone', 'is_active']
...
class UsuarioUpdateView(LoginRequiredMixin, CoordenadorRequiredMixin, UpdateView):
    model = Usuario
    fields = ['tipo', 'curso', 'nome', 'email', 'cpf','matricula', 'fone', 'is_active']
...
class UsuarioDeleteView(LoginRequiredMixin, CoordenadorRequiredMixin, DeleteView):
    model = Usuario
    success_url = 'usuario_list'
